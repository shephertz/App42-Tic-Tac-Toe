...
14. If you want to use your own facebook app, you have to create it in facebook developer console and modify FB_APP_ID variable to use your own facebook app id in Constants.java
13. Build and Run 
