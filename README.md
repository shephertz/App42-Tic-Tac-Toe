...
12. Modify ProjectNo in Constants.java file with your Google Project Number.
...
14. If you want to use your own facebook app, you have to create it in facebook developer console and modify FbAppId variable in Constants.java file to use your own facebook app id. 
15. Build and Run 
