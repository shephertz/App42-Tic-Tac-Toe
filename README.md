...
13. If you want to use your own facebook app, you have to create it in facebook developer console and modify FB_APP_ID variable in Constants.java file to use your own facebook app id. 
14. Build and Run 
