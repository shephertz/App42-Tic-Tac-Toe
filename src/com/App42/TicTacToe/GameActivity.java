...
public class GameActivity extends Activity implements AsyncApp42ServiceApi.App42ServiceListener{
	...
	public void onCreate(Bundle savedInstanceState) { 
        ...
        try {
			gameObject = new JSONObject( intent.getStringExtra(Constants.IntentGameObject) );
			this.initialize();
	...
	{        
		try {
			...
			else
			{
				...
				{
					((TextView) this.findViewById(R.id.status)).setText("Your turn.");
	...
	private String getUserName(){
		SharedPreferences mPrefs = getSharedPreferences(MainActivity.class.getName(),
				MODE_PRIVATE);
	...
	private final BroadcastReceiver mHandleMessageReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			((TextView) GameActivity.this.findViewById(R.id.status)).setText(newMessage);
			try {
