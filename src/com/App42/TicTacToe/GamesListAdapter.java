...
public class GamesListAdapter extends BaseAdapter implements
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (item != null) {
			...
			TextView tvOppName = (TextView) convertView
					.findViewById(R.id.opp_name);
	...
	public void onGetUserGamesList(final ArrayList<JSONObject> gamesList) {
		if (gamesList == null) {
			((UserHomeActivity) GamesListAdapter.this.context)
					.onOperationFail();
		} else {
